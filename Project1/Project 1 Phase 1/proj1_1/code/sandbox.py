...
initial_state = {'x': np.array([0, 0, 0]),
                 'v': np.zeros(3,),
                 'q': np.array([0,0,0,1]), # [i,j,k,w] # 0.0099667, 0.0993347, 0.0993347, 0.9900333
                 'w': np.zeros(3,)}

# yaw by 10 degree: 0, 0, 0.0871558, 0.9961947
# pitch by 10 degree:  0, 0.0871558, 0, 0.9961947
# row by 10 degree: 0.0871558, 0, 0, 0.9961947
